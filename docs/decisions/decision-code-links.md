...
| [DR-0008](accepted/DR-0008-metric-domain-budget-contract.md) | `packages/ethos/src/ethos/domain/source_budget/core.py`, `packages/ethos-core/src/ethos_core/contracts/source_budget/`, `system/commands.toml` | `tests/unit/domain/source_budget/test_core.py`, `tests/unit/kernel/test_source_budget_contract.py`, `tests/unit/adapters/repo/test_source_budget.py` | `ethos quality source-budget --json` |
