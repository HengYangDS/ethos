...
| [DR-0008](superseded/DR-0008-metric-domain-budget-contract.md) | Historical only; direct terminal measurement is owned by `src/ethos/domain/source_budget/core.py`. | `tests/unit/domain/source_budget/test_core.py` | `ethos quality source-budget --json` |
