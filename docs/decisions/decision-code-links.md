...
| [DR-0004](accepted/DR-0004-native-documentation-topology-contract.md) | `packages/ethos-core/src/ethos_core/contracts/docs/topology.py`, `packages/ethos/src/ethos/repository/policy/docs/topology.py`, `packages/ethos/src/ethos/repository/adoption/retirement/core.py` | `tests/unit/governance/test_docs_topology.py`, `tests/unit/cli/test_docs_topology_cli.py`, `tests/unit/adoption/test_retirement.py`, `tests/architecture/test_generated_artifact_topology_docs.py` | `ethos quality docs-topology --json`, `ethos fleet retirement-readiness --target <repo> --root <product> --json` |
...
| [DR-0008](accepted/DR-0008-metric-domain-budget-contract.md) | `packages/ethos/src/ethos/domain/source_budget/core.py`, `packages/ethos/src/ethos/domain/campaign/closeout.py`, `packages/ethos-core/src/ethos_core/contracts/source_budget/`, `system/commands.toml` | `tests/unit/domain/source_budget/test_core.py`, `tests/unit/kernel/test_source_budget_contract.py`, `tests/unit/adapters/repo/test_source_budget.py`, `tests/unit/governance/test_evolution_ledger.py` | `ethos quality source-budget --json` |
