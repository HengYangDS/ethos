...
| [DR-0002](superseded/DR-0002-documentation-topology-isomorphism-contract.md) | Documentation Topology Isomorphism Contract | superseded | governance | Superseded lifecycle-labeled lane topology. |
...
| [DR-0005](accepted/DR-0005-declarative-lifecycle-spine.md) | Declarative Lifecycle Spine | accepted | architecture | Singular lifecycle declaration, PlanIR compilation, command authority, and replaceable execution substrates. |
...
| [DR-0007](superseded/DR-0007-docs-kernel-invariance-and-adopter-parity-locus.md) | Docs Kernel Form-Invariance and Adopter-Parity Evidence Locus | superseded | architecture | Combined ruling split into DR-0004 v2 for docs topology and profile-scoped proof-host assurance. |
