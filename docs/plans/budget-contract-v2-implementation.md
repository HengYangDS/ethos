...
relations:
  ...
  governed_by: openspec/changes/budget-contract-v2-foundation-20260719
---
...
- Modify: `openspec/changes/budget-contract-v2-foundation-20260719/**`
...
`ethos.domain.prove` to `ethos.domain.source_budget.core`. Update the scorecard
import and declare:
...
- [ ] **Step 1: Write failing tests that recompute the immutable baseline from Git blobs and expose the 283-ELOC v1 semantic drift without rewriting the declaration.**
