...
content. The target is exactly
`/Users/yheng/projects/ethos-worktrees/codex-contracts-land-test-refactor`;
neither its parent, sibling lanes nor the symlink target is a deletion target.
