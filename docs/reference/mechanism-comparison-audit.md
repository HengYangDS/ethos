...
| Security and dependency hygiene | Secret scanning, dependency audits, vulnerability scans, tool-supply governance. | Gitleaks, Bandit, SBOM, release attestation active; dependency and vulnerability scanners planned. | Activate through separate security lanes with owner surfaces. |
