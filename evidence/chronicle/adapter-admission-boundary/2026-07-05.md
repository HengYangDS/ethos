...
- Added OpenSpec carrier `openspec/changes/archive/2026-07-05-ethos-adapter-admission-boundary`.
...
- OpenSpec archive: archived as `2026-07-05-ethos-adapter-admission-boundary` with `specsUpdated=true`.
