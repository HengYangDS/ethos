...
OpenSpec carrier: `openspec/changes/archive/2026-07-06-openspec-semantic-capability-layout`.

## Claim Boundary

This evidence binds the archived OpenSpec change
`openspec/changes/archive/2026-07-06-openspec-semantic-capability-layout` to the repository mutation that
