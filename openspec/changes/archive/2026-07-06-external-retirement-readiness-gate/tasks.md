...
- [x] 1. Expose profile tables needed for generic backend and adoption-boundary checks.
- [x] 2. Add a repository-layer retirement-readiness report with profile, binding, product-boundary, parity, shadow, and lifecycle checks.
