## 1. Deterministic tool supply

- [x] 1.1 Add failing adapter and CI/scaffold assertions for the exact 1.6.0 package.
- [x] 1.2 Pin the ETHOS fallback, CI bootstrap, and adopter scaffold to the official package.
