## 1. Reproduce and classify the zero-effect boundary
...
## 2. Bind the retained dirty package

- [x] 2.1 Verify decision
  `lane-decision:4f0f0ee2-7907-438f-acf1-91729d14796a`, completion receipt, and
  retained state.
- [x] 2.2 Bind manifest SHA-256
  `16c9f2e10bf2a9fde432eb543b15eef780cf786e83f679be2fa36b74909635d6`
  and its exact bundle, tracked patch, and index patch digests.
