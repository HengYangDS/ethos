...
- [x] Define bounded assurance classes and independent receipt contract.
- [x] Add disabled, optional, and required action policy with default disabled.
- [x] Bind `publish` admission to exact repository and gate-policy facts.
