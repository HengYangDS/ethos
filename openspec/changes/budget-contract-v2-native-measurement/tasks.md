...
- [x] 7.3 Commit the final pre-transition carrier and run exact-HEAD proof; then complete official archive inputs without claiming archive, candidate land, accepted closeout, publication, or Lane retirement prematurely.
