...
- [x] Define the three explicit freshness modes and their truth boundaries.
- [x] Add schema and claim-read-model enforcement with no implicit fallback.
- [x] Extract one semantic tree digest primitive shared with parity evidence.
