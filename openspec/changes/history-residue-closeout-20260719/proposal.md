...
OpenSpec specifications named above. No public transition command semantics are
changed; mutation remains Work-Lane-bound and local-state cleanup remains
non-authoritative.
