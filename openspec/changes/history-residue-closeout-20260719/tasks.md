...
- [ ] 1.1 Validate the proposal, design, and four capability deltas with strict OpenSpec validation.
...
- [ ] 6.5 Run `status -> plan -> prove --execute`, land to candidate, and verify local publish readiness without remote push.
