## 1. Reproduce And Prepare

- [x] 1.1 Retrieve the exact failed hosted receipt and isolate the absent cross-check tool.
- [x] 1.2 Add installer and shared-entry negative regressions; observe RED.

## 2. Close The Existing Supply Boundary
...
- [x] 3.5 Remove activation expression redundancy and make per-file size a real test prerequisite; verify both failed and unknown outcomes before heavy execution.
