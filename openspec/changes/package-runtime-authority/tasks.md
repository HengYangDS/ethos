...
- [x] 4.2 Run format before lint, focused tests, type/static gates, strict OpenSpec validation, full proof, and coverage. Archive, land, accepted installation, and adopter diagnostics remain lifecycle effects proved by their own receipts rather than prerequisites that make this Change complete.
