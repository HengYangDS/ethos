...
- [x] Reproduce the false stale-head rejection with a real detached replay
  commit in the focused hook-admission test.
- [x] Bind sanctioned rebase admission to the named Work Lane ref while keeping
