...
- [x] Define the typed external receipt model and claim schema declaration.
- [x] Fail closed on missing, malformed, stale, mismatched, and repository-local receipts.
- [x] Preserve `digest_only` as the account-free, provider-free default.
