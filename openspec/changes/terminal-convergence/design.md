...
| CL-016 | Verify commit signatures independently on each hosted provider; repair a local signature-only OID replacement without replaying stale candidate identity. | absorbed | `3.3`, `7.4` | local repair binds unchanged unsigned payload, current holder/Lease/proof, external trust and exact train CAS; each provider separately verifies hosted signature and release facts | identity-repair transaction tests plus GitLab and GitHub release observations |
...
| `6.3` | `880a591d82a15ab5b8e9abc281dc6b632d9b68d36811df3ef0ae76f98e6f35f4` | `e0848131ab935b08efa92f5881801a9634c863107eabc0c300977e4dd04913cd` | superseded | The historical single Python total allowed test deletion to fund product and cross-platform automation growth. Role-local ceilings plus the unchanged global ceiling provide stronger non-compensating evidence without excluding any owned source. |
...
| `3.5` | `7c6ffe539adeba2a9430fbc09bc21ff751382e2c7babcd3406caba7ed7932cd3` | `2dc2ff7f084ee85439e3bf4268f3d40c535d3a67798541674d7650e4c8449e0d` | clarified | Private-product and host-product coupling is absent from every product carrier, not only runtime source. |
...
| `portable-reference-boundary` | `3.4`, `3.5` | `accepted-spec-reconciliation` | Positive native ownership covers references and variation classes across code, tests, docs, schemas, templates, fixtures, and projections; product/private/host-coupling scans pass. |
