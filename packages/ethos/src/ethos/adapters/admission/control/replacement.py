...
_CONTROL_PREFIXES = (
    ...
    "system/",
    "tools/ci/",
    "packages/ethos-core/src/ethos_core/contracts/",
    "packages/ethos-core/src/ethos_core/measure.py",
    "packages/ethos/src/ethos/adapters/admission/",
    "packages/ethos/src/ethos/adapters/gates/",
    "packages/ethos/src/ethos/adapters/mutation/",
    "packages/ethos/src/ethos/adapters/repo/git.py",
    "packages/ethos/src/ethos/domain/campaign/",
    "packages/ethos/src/ethos/domain/land/",
    "packages/ethos/src/ethos/domain/report",
    "packages/ethos/src/ethos/domain/source_budget/",
    "packages/ethos/src/ethos/repository/adoption/",
    "packages/ethos/src/ethos/repository/context.py",
    "packages/ethos/src/ethos/repository/evidence/",
    "packages/ethos/src/ethos/repository/policy/",
    "packages/ethos/src/ethos/repository/profile.py",
    "packages/ethos/src/ethos/surface/cli/hook/",
    "packages/ethos/src/ethos/surface/cli/root/",
)
