...
from ethos.repository.command_registry import RETIRED_PUBLIC_ROOTS
from ethos.repository.command_registry import known_commands
...
DEFAULT_ALLOWED_STATES = {"canonical", "active", "experimental", "superseded", "archived"}
