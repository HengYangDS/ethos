...
from ethos.repository.policy.schema_samples import _campaign_closeout_contract_sample
...
from ethos.repository.policy.schema_samples import _workspace_status_contract_sample
