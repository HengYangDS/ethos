...
from ethos.adapters.repo.release import release_tag_publication_gaps
...
def push_admission_report(
    ...
    **options: object,
    ...
    ref_gaps.extend(release_tag_publication_gaps(repo, target_ref, remote_head, pushed_head))
    gaps = list(
        dict.fromkeys(
            (
                *ref_gaps,
