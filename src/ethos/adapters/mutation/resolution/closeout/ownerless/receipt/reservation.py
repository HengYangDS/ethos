    ...
    *,
    ...
    try:
        ...
        if isinstance(error, ValueError):
            return False, None, classify_closeout_failure(error, "lane_resolution_receipt_invalid")
        gap = (
...
def claim_effect_receipt_reservation(
    stack: ExitStack,
    control_root: Path,
    artifact_root: Path,
    decision_id: str,
...
def ownerless_reservation_admission_or_gap(
    *,
    root: Path,
    record_root: Path,
    decision_path: Path,
    ...
    try:
        ...
        return None, classify_closeout_failure(error, _OWNERLESS_RESERVATION_COMPETING)
