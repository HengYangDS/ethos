...
from ethos.contracts.resolution.lane import LaneResolutionClearReceipt
...
def write_resolution_receipt(
    *,
    ...
    payload = _validated_resolution_receipt(root=root, receipt=receipt)
...
def _validated_resolution_receipt(*, root: Path, receipt: dict[str, object]) -> dict[str, object]:
    try:
