...
def observe_python_facts(python: Path) -> dict[str, str]:
    ...
    required = ("python_abi", "python_version", "python_implementation", "prefix", "base_prefix")
...
def observe_runtime_environment(source: Path, interpreter: Path) -> RuntimeEnvironment:
