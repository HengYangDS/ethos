...
def test_retirement_readiness_accepts_adopter_declared_compatibility_docs_roots(
    ...
    assert report["checks"]["docs_topology"]["profile_policy"]["state_root_policy"] == (
        "adopter_declared_compatibility"
    )
    assert report["checks"]["docs_topology"]["time_state_roots"] == [
        "docs/current",
        "docs/future",
    ]
...
def test_retirement_readiness_accepts_profile_mapped_legacy_status_lines(
    ...
    for path in [
        ...
        adopter / "docs/evidence/README.md",
        adopter / "docs/history/README.md",
        adopter / "docs/decisions/README.md",
        adopter / "docs/decisions/decision-index.md",
        adopter / "docs/decisions/decision-dependency-map.md",
        adopter / "docs/decisions/decision-code-links.md",
        adopter / "docs/decisions/accepted/README.md",
        adopter / "docs/decisions/superseded/README.md",
        adopter / "docs/decisions/templates/README.md",
        adopter / "docs/decisions/templates/decision-record.md",
    ]:
    ...
    assert report["ok"] is True
    assert report["required_gaps"] == []
    assert report["checks"]["docs_topology"]["profile_policy"]["state_metadata_policy"] == (
        "front_matter_or_status_line"
    )
