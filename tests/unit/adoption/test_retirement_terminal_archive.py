...
def test_retirement_readiness_accepts_terminal_embedded_retired_history_restore_state(
    tmp_path: Path,
) -> None:
    ...
    write_profile(
        adopter,
        external_state="retired",
        embedded_state="retired",
        rollback=rollback,
        control={
            "state": "retired",
            "default_backend": "external",
            "external_backend": "retirement_ready",
            "rollback_mode": "git_revert_or_restore_from_history",
        },
    )
