...
def test_docs_topology_front_matter_state_edge_cases(tmp_path: Path) -> None:
    ...
    assert not hasattr(docs_topology_module, "_front_matter_state")
    assert docs_topology_module._front_matter_field(closed_without_state, "state:") == ""
    assert docs_topology_module._front_matter_field(unclosed_without_state, "state:") == ""
    assert docs_topology_module._front_matter_field(tmp_path / "missing.md", "state:") == ""
