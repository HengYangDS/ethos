...
def test_new_submit_push_reconciles_divergent_origin_and_github_identity_baselines(
    ...
    report = push_admission_report(
        ...
        pushed_head=pushed_head,
        remote_head="0" * 40,
        reconciliation_receipt_path=receipt_path.as_posix(),
        observed_origin_head=origin_head,
        observed_github_head=legacy_head,
    )
...
def test_new_submit_push_blocks_reconciliation_receipt_when_remote_observation_is_stale(
    ...
    report = push_admission_report(
        ...
        remote_head="0" * 40,
        reconciliation_receipt_path=receipt_path.as_posix(),
        observed_origin_head="different-head",
        observed_github_head=github_head,
    )
